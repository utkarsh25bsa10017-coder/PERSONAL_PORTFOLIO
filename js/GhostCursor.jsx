/*
 * GhostCursor — official React Bits component (free JS-CSS variant, pulled from
 * the @react-bits shadcn registry). Ported for this no-build static site:
 *   - React comes from the CDN UMD global; three.js + postprocessing passes come
 *     from window.GhostCursorLib (see js/ghost-cursor-lib.js + importmap in index.html)
 *   - styles live in js/GhostCursor.css (linked from index.html)
 *   - mounted onto [data-ghostcursor] placeholders by js/app.jsx
 */
(() => {
const { useEffect, useMemo, useRef } = React;
const { THREE, EffectComposer, RenderPass, ShaderPass, UnrealBloomPass } = window.GhostCursorLib;
