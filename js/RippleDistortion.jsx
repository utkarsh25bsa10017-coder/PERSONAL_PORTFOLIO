/*
 * RippleDistortion — React Bits (https://reactbits.dev)
 * Adapted for a no-build static site:
 *   - React + ogl are loaded as globals (js/ogl.umd.js vendored bundle -> window.OGL)
 *   - styles live in js/RippleDistortion.css (linked from index.html)
 */
(() => {
const { useEffect, useRef } = React;
const { Renderer, Program, Mesh, Geometry, Triangle, Texture, RenderTarget } = window.OGL;
